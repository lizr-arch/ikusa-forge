...
- Live Viewer Performance Pass / 实时回放性能修复（renderLiveFrame / 实时帧渲染、30 FPS render loop / 30 帧渲染循环、capped live timeline / 限制实时时间线、Performance / 性能 观测）
...
- `docs/process/live-viewer-performance-pass-v0.1.md`
