...
This repository is currently in Phase 1 Data Config v0.1.1 state.
...
- v0.1/v0.1.1 reads CSV sample data from `config/source/sample_data/*.csv`.
...
Data Config v0.1/v0.1.1 uses CSV sample data first because it gives a dependency-free closed loop for schema, exporter, validator, and tests. This keeps Phase 1 moving without adding an xlsx parser before the data shape is stable.
